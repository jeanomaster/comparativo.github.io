...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">About
                    <small>Web Designers' Information</small>
                </h1>
                <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-5">
                <img class="img-responsive" src="image/feueac.gif" width="300" height="300" alt="">
            </div>
            <div class="col-md-6">
                <h2>Far Eastern University - East Asia College (2012 - Present )</h2>
...
FEU Tech operates under the aegis of Far Eastern University; it follows and is directly connected to Far Eastern University. However, it is headed by Michael M. Alba as university president and Benson T. Tan as executive director. </p>
             </div>
        </div>
        <!-- /.row -->
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-center">
                <div class="thumbnail">
                    <img class="img-responsive img-circle" src="image/Jeano.jpg" width="300" height="300" alt="">
                    <div class="caption">
                        <h3>Jeano J. Centeno<br>
            ...
            <div class="col-md-6 text-center">
                <div class="thumbnail">
                    <img class="img-responsive img-circle" src="image/Brian.jpg" width="300" height="300" alt="">
                    <div class="caption">
                        <h3>Brian B. Comparativo<br>
                            <small>Wolf</small>
                        </h3>
                        <p>Awooooooooooooooooooooooo! *cough* wooooooooooooooo!</p>
                        <ul class="list-inline">
                            <li><a href="#"><i class="fa fa-2x fa-facebook-square"></i></a>
                            </li>
                            <li><a href="#"><i class="fa fa-2x fa-twitter-square"></i></a>
